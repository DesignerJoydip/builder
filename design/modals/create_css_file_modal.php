...
<!-- Modal -->
<div class="modal fade" id="create_css_file_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- form open -->
      <input type="text" value="<?php echo $FLDNAME; ?>" id="create_file_mainFolder">
