...
<h3 class="panel-title"><?php echo $FLDNAME; ?><a href="<?php echo "design-folders/".$FLDNAME; ?>" class="btn btn-xs btn-default pull-right" target="_blank" style="color:#333; margin-top:-2px;">View Live</a>
<a href="edit-design-html.php?FLDNAME=<?php echo $FLDNAME; ?>" class="btn btn-xs btn-danger pull-right" style="margin-top:-2px; margin-right:10px;">Edit Code</a>
...
<iframe width="100%" height="500px" scrolling="auto" src="<?php echo "design-folders/".$FLDNAME; ?>" frameborder="0"></iframe>
</div> 
</div>
<?php }else{
