    ...
    <ul class="slider fullwidthSlider">
        <li>
        	...
        	<div class="bannerContainer">
        		<h3>Generous Health</h3>
        		<div>We take care of our employees by providing generous health</div>
        	</div>
        </li>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="quickServiceBox">
		        	...
		        	<div class="btnWrap">
		        		<a class="btn btn-lg btnicon">At Home Services <i class="fa fa-angle-right"></i></a>
		        	</div>
				</div>
			</div>
		        ...
		        <li>
		        	<div class="commntWrap">
	        			<div class="comntCntWrap quote">
	        				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aliquam metus at fringilla elementum. Sed condimentum lobortis mi. Nulla pulvinar dui nec. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis Sed condimentum lobortis mi. Nulla pulvinar dui nec.</p>
	        				<div class="actionArea">
	        					<a href="#" class="linktext">Author name</a>
	        				</div>
	        			</div>
	        		</div>
		        </li>
		...
		<div class="row">
			<div class="col-md-4">	
				<div class="supportBox">
					<h3>dasd hsakhdsah dkashdksahd</h3>
					<div class="imgbox">
						<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/banner-1.jpg">
					</div>
				</div>	
			</div>
			<div class="col-md-4">	
